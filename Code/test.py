...
def parse_args():
    ...
    parser.add_argument('--testset_dir', type=str, default='/root/autodl-tmp/test/test_4xSR_5x5/')
    ...
    parser.add_argument('--model_path', type=str, default='/root/autodl-tmp/CSWin/log/CSWin-ErrorFeedbackNet_4xSR_5x5_epoch_70.pth.tar')
    parser.add_argument('--save_path', type=str, default='/root/autodl-tmp/CSWin/Results/')

    parser.add_argument('--psnr_ssim_save_path', type=str, default='/root/autodl-tmp/CSWin/PSNRSSIM/')

    parser.add_argument('--load_model', type=str, help='Path to the model file to load')
...
def test(cfg, test_Names, test_loaders):
    ...
    net = Net(cfg.angRes, cfg.upscale_factor, 60)
    net.to(cfg.device)
